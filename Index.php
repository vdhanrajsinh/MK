...
<html lang="en">
  <head>
    ...
    <link href="css/dash_1.css" rel="stylesheet" type="text/css" />
  ...
  <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    ...
    <script src="js/dash_1.js"></script>
...
<!--
      ...
      <li>
		...
		<ul class="sidebar-submenu">
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> eCommerce</a></li>
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> Human Resources</a></li>
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> Digital Marketing</a></li>
          <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> Property Listings</a></li>
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> Services &amp; Support</a></li>
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> Logistics</a></li>
		</ul>
      </li>
         <li>
        <a href="javaScript:void();" class="waves-effect" >
          <i class="zmdi zmdi-view-dashboard"></i> <span>Dashboard2</span><i class="fa fa-angle-left pull-right"></i>
        </a>
		<ul class="sidebar-submenu">
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> eCommerce</a></li>
		  <li><a href="#"><i class="zmdi zmdi-dot-circle-alt"></i> Human Resources</a></li>
      ...
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark shadow-lg sticky-top">
    
      <a href="#" class="opensidemenubtn" onclick="openSlideMenu()">
        <svg height="30px" width="30px">
          <path d="M0,4 25,4" stroke="red" stroke-width="4px"/>
          <path d="M0,14 25,14" stroke="red" stroke-width="4px"/>
          <path d="M0,23 25,23" stroke="red" stroke-width="4px"/>
        </svg>
      </a>
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#sidebardata">
        <span></span>

        </button>

      
        <div class="collapse navbar-collapse" id="sidebardata">
            <ul class="navbar-nav nav nav-pills" role="tablist">
              ...
              <li >
                <a  data-toggle="pill" href="menu.html#menu2">Menu 2</a>
              </li>
                  ...
                  <li class="dropdown9">
                     ...
                     <a href="#"> <img src="img/user1.png" class="img-fluid rounded-circle dropbtn9" onclick="myFunction9()">
                        </a>
                          <div class="col-12 col-lg-6 col-xl-5 my-2">
                  <div id="myDropdown9" class="dropdown-content9">
                      <a href="#" class="usermainname12">
                    <!--  <div class="media">
                      <img class="mr-3 img-fluid imginsidedetails rounded-circle" src="img/user1.png"  alt="Generic placeholder image">
                      <div class="media-body">
                        <h5 class="mt-0">Media heading</h5>
                        <p style="font-size:10px;">vaghksdjfksandvjkasdhfjkasdhvjksdhc@gmail.com</p>
                        
                      </div>
                    </div>
                           <div class="media mt-3">
                             <img class="mr-3 img-fluid imginsidedetails avatar" src="img/user1.png"  alt="Generic placeholder image">
                            <div class="media-body">
                              <h4>Vaghela Dhanrajsinh</h4>

                              <p style="font-size:10px;">vagheladhanrajsinh123@gmail.com</p>
                            </div>
   </div>
                    ...
                    <a href="#about">Hi</a>
                      <div class="dropdown-divider"></div>
                    <a href="http://codervent.com/bulona/demo/index.html">Logout</a>
                  </div>
                      </div>
                </li>
     ...
     <div class="searchalignment">
       <button type="submit" id="searchbtnbig" onclick="openSearch1()"><i class="fa fa-search"></i></button>
    
      <input id="searchbig"  type="text" name="search" placeholder="Search..">

      <button id="searchclosebtn1" onclick="closeSearch1()" type="button">&times;</button>
  ...
  <input type="text" placeholder=" "/><span></span>
    ...
    <script>
      jQuery(function($){
          ...
          document.getElementById('searchbig').style.width='240px';
          document.getElementById('searchclosebtn1').style.display='block'
          document.getElementById('searchbig').style.transition='0.3s';
          document.getElementById('searchbtnbig').style.borderBottomLeftRadius='0px';
          document.getElementById('searchbtnbig').style.borderBottomRightRadius='7px';
          document.getElementById('searchbtnbig').style.borderTopLeftRadius='0px';
          document.getElementById('searchbtnbig').style.borderTopRightRadius='7px';
          document.getElementById('searchbtnbig').style.backgroundColor='#4CAF50';
         
                }
        function closeSearch1(){
         document.getElementById('searchbig').style.width='0';
         document.getElementById('searchbig').style.transition='0.3s';
         document.getElementById('searchclosebtn1').style.display='none';
         document.getElementById('searchbtnbig').style.borderRadius='50%';
         document.getElementById('searchbtnbig').style.backgroundColor='#fff';
